...
void main() {
  group('IconCheckbox_base', () {
    testWidgets('IconCheckbox_Base_action_currently',
      ...
      expect(find.byIcon(Icons.lightbulb_outline_rounded),
          findsOneWidget); // チェックアイコンの色の確認
      final Icon unCheckIcon =
          tester.widget<Icon>(find.byIcon(Icons.lightbulb_outline_rounded));
      ...
      final Icon checkIcon =
          tester.widget<Icon>(find.byIcon(Icons.lightbulb_outline));
  ...
  group('IconCheckbox_unCheckColor', () {
    testWidgets('IconCheckbox_change_unCheckColor',
        (WidgetTester tester) async {
      bool isChecked = false;
      const defaultCheckColor = Colors.blue;
      const testColor = Colors.red;
  ...
  group('IconCheckbox_boxdecoration', () {
    testWidgets('IconCheckbox_change_boxdecoration',
        (WidgetTester tester) async {
      bool isChecked = false;
  ...
  group('IconCheckbox_error', () {
    bool isChecked = false;
    testWidgets('unCheckColor and boxdecoration null',
        (WidgetTester tester) async {
      runZonedGuarded(() async {
        ...
        expect(error.toString(),
            contains('checkedIcon and boxdecoration cannot be both null'));
      });
    });
  });
}
